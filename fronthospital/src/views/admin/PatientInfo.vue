      ...
      <div class="row">
        ...
        <div class="col-md-12" style="font-size: 20px">
          <div class="row">
            ...
            <div class="col-md-9">
              <div>
                <h2 style="text-align: left">患者信息管理</h2>
              </div>
    ...
    export default {
        ...
        methods: {
            ...
            get_list: async function () {
                let self = this;
                let {data} = await this.$http.get('/admin/getPatientInfo',this.params)
                console.log(data)
                self.list = data
            ...
            handleDelete: async function (item) {
                let self = this;
                this.$confirm('此操作将删除该患者, 是否删除?', '提示', {
                    confirmButtonText: '确认',
                    cancelButtonText: '取消',
                    type: 'info'
                }).then(async () => {
                    let that = this
                    this.$http.post('/admin/removePatientInfo',{patientId:item.patientId}).then(
                        function (obj){
                            that.$message({
                                showClose: true,
                                message: '删除成功',
